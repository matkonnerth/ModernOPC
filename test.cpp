...
// template <typename T>
// using HasconvertToUAVariantImpl = typename
// HasconvertToUAVariantImpl_<T>::type;

// /* ADL (argument dependent lookup) is used for binding the
// convertToUAVariantImpl . If convertToUAVariantImpl is found in the namespace
// of the argument type, this template function will be instantiated.

// That means, the conversion function has to reside in the namespace of the
// concerning type. For types in the standard library, this conversion function
// has to reside in namespace std.
// */
// template <typename T>
